...
public class LessonsPageNotifications extends AppCompatActivity implements BottomNavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        imgLike.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (postStatus.equals("1")){
                    ...
                    getLogEvent(LessonsPageNotifications.this);
                    getLessonsLikeDislike(LessonsPageNotifications.this,postId,postStatus);
        ...
        btnEnrollLesson.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                enrollFunction(LessonsPageNotifications.this);
            }
        });
        ...
        txtPdfTitle.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (pdfURL.equals("")) {
                    ...
                    getLogEvent(LessonsPageNotifications.this);
                    pdfDialogue(LessonsPageNotifications.this);
                }
            }
        });
    ...
    public void onConfigurationChanged(Configuration newConfiguration) {
        ...
        if (newConfiguration.orientation == Configuration.ORIENTATION_LANDSCAPE) {
            ...
            playerLayout.setLayoutParams(new LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT,400));
        }
    }
    @Override
    ...
    public void enrollFunction(Context context){
        ...
        getLogEvent(LessonsPageNotifications.this);
        new AppsFlyerEventsHelper(LessonsPageNotifications.this).EventEnroll();
        Intent intent = new Intent(LessonsPageNotifications.this,EnrolNowActivity.class);
        sharedPrefsUtils.setSharedPrefBoolean(ApiConstants.isFromCourse, false);
        intent.putExtra("getCourseId",Integer.parseInt(getIntent().getStringExtra("CourseId")));
    ...
    public void getLessonData(){
        ...
        if (getIntent().getStringExtra("lessonId") != null) {
            ...
            lessonData = new LessonData(Integer.parseInt(getIntent().getStringExtra("lessonId")), "english");
        } else {
            ActivityLog = "Notification Clicked";
            lessonData = new LessonData(Integer.parseInt(UserDataConstants.notificationID), "english");
        }
        Call<LessonData> call = apiService.getLessonData(lessonData);
        hocLoadingDialog.showLoadingDialog();
        call.enqueue(new Callback<LessonData>() {
            @Override
            public void onResponse(Call<LessonData> call, retrofit2.Response<LessonData> response) {
                hocLoadingDialog.hideDialog();
                txtLessonName.setText(response.body().getLessonDetail().getLesson_title());
                headerTitle.setText(response.body().getLessonDetail().getCourse_title());
                txtDescription.setText(response.body().getLessonDetail().getLesson_description());
                txtImageText.setText(response.body().getLessonDetail().getCourse_title());

                if (response.body().getLessonDetail().getLesson_image_url().equals("")){
                    imgLesson.setVisibility(View.GONE);
                } else {
                    Glide.with(LessonsPageNotifications.this)

                            .load(response.body().getLessonDetail().getLesson_image_url())
                ...
                if (response.body().getLessonDetail().getStudy_material_url().equals("")) {
                    txtPdfTitle.setVisibility(View.GONE);
                } else {
                ...
                getLessonsLikeDislike(LessonsPageNotifications.this,"1",postStatus);
                mp4URL = response.body().getLessonDetail().getVideo_url();
                playVideoAtSelection();
                CategoryName = "";
                CourseLog = response.body().getLessonDetail().getCourse_title();
                LessonLog = txtLessonName.getText().toString();
                postId = "";
    ...
    public void onBackPressed() {
        super.onBackPressed();
        startActivity(new Intent(LessonsPageNotifications.this, HomePageActivity.class));
