...
public class BuzzDetailsDialog {
    ...
    CommentBlockReportDialoge reportDialoge;

    public BuzzDetailsDialog (Context context, int position, List<HocTodayData> dataMainList,String term_id) {
    ...
    public void getHocTodayList() {
        HocTodayResponse hocTodayResponse = new HocTodayResponse("Hamstech",context.getResources().getString(R.string.lblApiKey),
                UserDataConstants.userMobile,langPref,"hamstechtoday",String.valueOf(term_id));
            ...
            try {
                ...
                holder.imgReport.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        reportDialoge = new CommentBlockReportDialoge(context,Integer.parseInt(dataBuzz.get(position).getComment_id()),
                                mobile,dataBuzz.get(position).getComment());
