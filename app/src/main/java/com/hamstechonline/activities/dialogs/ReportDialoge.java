...
public class ReportDialoge {
    ...
    public ReportDialoge(Context context,int Postid,String mobile){
    ...
    public class HocOptionsAdapter extends RecyclerView.Adapter<HocOptionsAdapter.ViewHolder> {
        ...
        @Override
        public void onBindViewHolder(@NonNull final HocOptionsAdapter.ViewHolder holder, final int position) {
            try {
