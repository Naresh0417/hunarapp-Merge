...
public class ExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    public ExpandableListAdapter(Context context, ArrayList<HeaderInfo> deptList,int CatId,String CategoryName, String CourseName) {
    ...
    public View getChildView(final int groupPosition, final int childPosition, boolean isLastChild,
        ...
        if (groupPosition == 0){
            ...
            btnNext.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    LessonLog = "";
                    ActivityLog = "Get our free starter kit";PagenameLog = "Enrol Now button";
                    getLogEvent(context);
                    EnrolNow(CatId);
                }
            });
