...
public class MiniLessonsExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    public MiniLessonsExpandableListAdapter(Context context, ArrayList<HeaderInfo> deptList, int CatId, String CategoryName, String CourseName) {
    ...
    public Object getChild(int groupPosition, int childPosition) {
        ...
        // ArrayList<ListInfo> productList = deptList.get(groupPosition).getProductList();
        ...
        if (groupPosition == 0){
            ...
            btnNext.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    LessonLog = "";
                    ActivityLog = "Accordion";PagenameLog = "Enrol Now button";
                    getLogEvent(context);
                    EnrolNow(CatId);
                }
            });
