...
public class LessonsFragment extends Fragment {
    ...
    public static LessonsFragment newInstance(String text) {
            ...
            try {
                ...
                holder.mainLayout.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (position == 0){
                            new AppsFlyerEventsHelper(context).EventLessonsDetails(coursesList.get(position).getCategory_name(),
                        ...
                        if (coursesList.get(position).getLock_status() == 0) {
                            ...
                            intent.putExtra("getCourseId", Integer.parseInt(coursesList.get(position).getCourseId()));
                            ...
                            ActivityLog = "Click";
                            PagenameLog = "Course Page";
                            params.putString(AppEventsConstants.EVENT_PARAM_CONTENT_TYPE, coursesList.get(position).getLesson_title());
                            params.putString(AppEventsConstants.EVENT_PARAM_CONTENT_ID, coursesList.get(position).getCourse_title());
                            logger.logEvent(AppEventsConstants.EVENT_PARAM_SEARCH_STRING,params);
                            //getLogEvent(context);
                            Intent intent = new Intent(context, LessonsPageActivity.class);
                            intent.putExtra("videoURL", coursesList.get(position).lesson_video_url);
                            intent.putExtra("CategoryName", coursesList.get(position).getCategory_name());
                            intent.putExtra("CourseName", coursesList.get(position).getCourse_title());
                            intent.putExtra("LessonName", coursesList.get(position).getLesson_title());
                            intent.putExtra("description", coursesList.get(position).getLesson_description());
                            intent.putExtra("pdfURL", coursesList.get(position).study_material_url);
                            ...
                            intent.putExtra("LessonImage", coursesList.get(position).getLessonImage());
                            intent.putExtra("LessonText", coursesList.get(position).getTextImage());
                            intent.putExtra("LessonData", (ArrayList<LessonsDataModel>) unlockedLessonsList);
