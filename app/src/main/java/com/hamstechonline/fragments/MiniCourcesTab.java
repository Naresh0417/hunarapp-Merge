...
public class MiniCourcesTab extends Fragment {
    ...
    TextView txtTotalFee,txtStrike;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        txtStrike = v.findViewById(R.id.txtStrike);
        ...
        if(getActivity().getIntent().getStringExtra("CategoryId") != null) {
            ...
            txtStrike.setText(stike);
            txtStrike.setPaintFlags(txtStrike.getPaintFlags() | Paint.STRIKE_THRU_TEXT_FLAG);
            txtTotalFee.setText(getActivity().getIntent().getStringExtra("amount")+"/-");
        ...
        btnEnrolNow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                CourseLog = getActivity().getIntent().getStringExtra("CourseName");LessonLog = "";
                ActivityLog = "Overview";PagenameLog = "Enroll Page";
    ...
    public static MiniCourcesTab newInstance(String text) {

        MiniCourcesTab f = new MiniCourcesTab();
        Bundle b = new Bundle();
            ...
            public void onResponse(String response) {
                try{
                    ...
                    if (jo.getString("status").equals("ok")) {
                        ...
                        txtTitle.setText(getActivity().getResources().getString(R.string.minilessons_overview));
